...
function ponytail(color, tip, len = 0.20) {
  return {
...
function beard(color, tip, len = 0.016, n = 110) {
  return [
...
export const NPC_CAST = {
  ...
  trucker: {
    ...
    look: {
      ...
      skin: srgb(0xc99562), iris: 0x5b6a55,
  ...
  mechanic: {
    ...
    look: {
      ...
      skin: srgb(0xc08a5e), iris: 0x40607d,
  ...
  traveller: {
    ...
    look: {
      ...
      stance: 0.5,
      skin: srgb(0xcea070), iris: 0x6a4a7c,
  ...
  kid: {
    ...
    look: {
      ...
      skin: srgb(0xd8a879), iris: 0x3f6f9c,
