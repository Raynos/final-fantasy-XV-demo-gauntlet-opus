 ...
 *
 * `tools/heightcheck.mjs` answers a narrower question: it evaluates the shared
 ...
 *
 *   node tools/driftcheck.mjs                 # default home shot + full tour
 *   node tools/driftcheck.mjs --home hero_full
 *   node tools/driftcheck.mjs --span 320 --res 192
 *   node tools/driftcheck.mjs --tol 0.05      # fail above this drift, metres
 *
...
const out = await page.evaluate(async (cfg) => {
  ...
  // browser is doing the import, not vite. Same trick as tools/heightcheck.mjs.
