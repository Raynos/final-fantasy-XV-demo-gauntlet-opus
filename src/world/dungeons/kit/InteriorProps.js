...
import * as M from './InteriorMaterials.js';
...
export class PropKit {
  /**
   * @param {object} o
   * @param {import('./Build.js').InteriorMerger} o.merger
   * @param {import('./LightRig.js').LightRig} o.rig
   * @param {import('./Layout.js').Layout} o.layout
