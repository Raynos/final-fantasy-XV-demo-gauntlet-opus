...
import { LODGINGS, nightScaling } from './Stats.js';
...
export class DayCycle {
   ...
   *
   * @param {object} ctx
   * @param {import('./Stats.js').ExpBank} ctx.expBank
   * @param {import('./PartyState.js').PartyState} ctx.party
   * @param {import('./Inventory.js').Inventory} [ctx.inventory] to pay for hotels
