...
function parseArgs(argv) {
  const o = { w: 1600, h: 900, frames: 120, warmup: 40, q: 'ultra', shots: [], target: 60, breakdown: false, out: null };
...
async function main() {
  ...
  try {
    ...
    for (const name of shots) {
      const r = await page.evaluate(async ([n, frames, warmup, breakdown]) => {
        const g = window.GAME;
      ...
      }, [name, o.frames, o.warmup, o.breakdown]);
